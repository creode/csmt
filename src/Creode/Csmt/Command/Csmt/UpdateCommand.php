 ...
 * @license    https://github.com/creode/csmt/blob/master/LICENSE
 */
...
class UpdateCommand extends BaseCommand
{
    ...
    const PHAR_URL = 'https://creode.github.io/csmt/downloads/csmt.phar';

    const PACKAGE_NAME = 'creode/csmt';

    const FILE_NAME = 'csmt.phar';
